package com.octopus.moviesapp.android.ui.movies

import android.os.Bundle
import android.view.View
import androidx.lifecycle.lifecycleScope
import com.octopus.moviesapp.R
import com.octopus.moviesapp.android.viewmodels.movies.MoviesViewModel
...
class MoviesFragment : BaseFragment<FragmentMoviesBinding>() {
    ...
    private fun navigateToMovieDetails(movieId: Int) {
        requireView().findNavController()
            .navigate(MoviesFragmentDirections.actionMoviesFragmentToMovieDetailsFragment(movieId))
    }
}