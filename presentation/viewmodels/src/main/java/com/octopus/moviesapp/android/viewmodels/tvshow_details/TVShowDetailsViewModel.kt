package com.octopus.moviesapp.android.viewmodels.tvshow_details

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.SavedStateHandle
import androidx.lifecycle.ViewModel
import com.octopus.moviesapp.android.usecases.tvshows.GetTVShowCastUseCase
import com.octopus.moviesapp.android.usecases.tvshows.GetTVShowDetailsByIdUseCase
import com.octopus.moviesapp.android.usecases.tvshows.GetTVShowTrailerUseCase
import com.octopus.moviesapp.android.viewmodels.tvshow_details.mapper.asCastUiState
import com.octopus.moviesapp.android.viewmodels.tvshow_details.mapper.asDetailsUiState
import com.octopus.moviesapp.android.viewmodels.tvshow_details.mapper.asTrailerUiState
...
class TVShowDetailsViewModel @Inject constructor(
...
) : ViewModel(), NestedGenresListener, NestedCastListener, NestedSeasonsListener {
    ...
    private fun onSuccess(
        trailerResult: TrailerUiState, detailsResult: DetailsUiState, castsResult: List<CastUiState>
